...
@section('main-content')
    ...
    <div class="modal fade" id="unitImportModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('admin.imports.units') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <a href="{{ route('admin.imports.sample.units') }}" class="btn btn-outline-primary">
                                <i class="fa-solid fa-download"></i> Download Sample File
                            </a>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Select CSV or XLSX</label>
                            <input type="file" name="file" class="form-control js-import-preview-input" data-preview-target="#unitImportPreview" accept=".csv,.xlsx" required>
                        </div>
                        <div class="d-none" id="unitImportPreview"></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button>
