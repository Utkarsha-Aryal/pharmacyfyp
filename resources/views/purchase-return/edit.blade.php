                        ...
                        <tbody>
                            @forelse ($itemsRows as $index => $row)
                                <tr data-sync-mode="percent">
                                    ...
                                    <td><input type="number" name="items[{{ $index }}][rate]" class="form-control purchase-return-rate-input" min="0" step="0.01" value="{{ $row['rate'] }}"></td>
                                    <td><input type="number" name="items[{{ $index }}][discount_percent]" class="form-control purchase-return-discount-input" min="0" max="100" step="0.01" value="{{ $row['discount_percent'] }}"></td>
                                    <td><input type="number" name="items[{{ $index }}][discount_amount]" class="form-control purchase-return-discount-amount-input" min="0" step="0.01" value="{{ $row['discount_amount'] }}"></td>
                                    <td><input type="number" name="items[{{ $index }}][net_rate]" class="form-control purchase-return-net-rate-input" min="0" step="0.01" value="{{ $row['net_rate'] }}"></td>
                                    <td><input type="text" name="items[{{ $index }}][return_amount]" class="form-control purchase-return-amount-input" value="{{ $row['return_amount'] }}" readonly></td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="11" class="text-center text-muted">No returnable items found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
