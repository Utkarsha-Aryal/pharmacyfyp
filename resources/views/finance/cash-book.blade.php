    ...
    <div class="admin-page-wrap">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            ...
            <div class="d-flex gap-2 mt-3 mt-md-0">
                ...
                <a href="{{ route('admin.export.cash-book-pdf', request()->query()) }}" target="_blank" class="btn btn-pdf">
                    <i class="fa-solid fa-file-pdf"></i> PDF
                </a>
                <a href="{{ route('admin.export.cash-book-pdf', request()->query()) }}" target="_blank" class="btn btn-primary">
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2">
                            <div class="d-flex gap-2 justify-content-end">
                                ...
                                <a href="{{ route('admin.finance.cash-book') }}" class="btn btn-outline-secondary btn-sm icon-only-btn" title="Reset Filter" aria-label="Reset Filter">
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="cashBookTable" class="table table-bordered align-middle w-100">
                            <thead>
                                <tr>
...
@section('script')
    <script>
        $(document).ready(function () {
            window.cashBookTable = window.initServerSideDataTable({
                selector: '#cashBookTable',
                pageLength: 15,
                sort: false,
                searchable: true,
                columns: [
                ...
                ajaxUrl: '{{ route('admin.finance.cash-book.list') }}',
            ...
            $(document).on('change', '.filter-card select, .filter-card input', function () {
                if (window.cashBookTable) {
                    window.cashBookTable.draw();
                }
            });
        });
    </script>
